...
class InventoryItemsControllerTest < ActionController::TestCase
  ...
  test "should create inventory_item" do
    assert_difference('InventoryItem.count') do
      post :create, inventory_item: { name: @inventory_item.name, quantity: @inventory_item.quantity, unit: @inventory_item.unit }
    end
  ...
  test "should update inventory_item" do
    put :update, id: @inventory_item, inventory_item: { name: @inventory_item.name, quantity: @inventory_item.quantity, unit: @inventory_item.unit }
    assert_redirected_to inventory_item_path(assigns(:inventory_item))
  end
